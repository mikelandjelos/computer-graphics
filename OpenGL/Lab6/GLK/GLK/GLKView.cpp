...
{
	if (m_sceneRotating)
		m_glRenderer.ChangeView(0.f, (FLOAT)point.y - m_oldMousePosition.y, (FLOAT)point.x - m_oldMousePosition.x), Invalidate();
...
{
	m_glRenderer.ChangeView(zDelta > 0 ? -1.f : 1.f, 0.f, 0.f), Invalidate();
